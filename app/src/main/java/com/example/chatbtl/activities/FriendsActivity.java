...
public class FriendsActivity extends BaseActivity implements UserInterface {
    ...
    private void sort2(List<User> friends) {
        Collections.sort(friends, (user1, user2) -> user1.getName().compareToIgnoreCase(user2.getName()));
    ...
    private void setListeners() {
        ...
        binding.iconSearch.setOnClickListener(v -> {
            Log.d("a", "aaaa");
            Collections.sort(friends, (user1, user2) -> user1.getName().compareTo(user2.getName()));
            userAdapter = new UserAdapter(friends, this);
    ...
    private void searchFriends(List<User> friends, String name) {
        List<User> friendSearches = new ArrayList<>(friends);
